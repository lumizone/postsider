    ...
    <html>
      ...
      >
        <VariableContextComponent
          ...
          genericOauth={!!process.env.POSTSIDER_GENERIC_OAUTH}
          oauthLogoUrl={process.env.NEXT_PUBLIC_POSTSIDER_OAUTH_LOGO_URL!}
          oauthDisplayName={process.env.NEXT_PUBLIC_POSTSIDER_OAUTH_DISPLAY_NAME!}
        ...
        >
          <SentryComponent>
            ...
            <Plausible
              domain={!!process.env.IS_GENERAL ? 'postsider.com' : 'gitroom.com'}
            >
              <PHProvider
