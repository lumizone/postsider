 ...
 *   POSTSIDER_API_URL  (required) - instance base URL, for example
...
const baseUrl = process.env.POSTSIDER_API_URL;

if (!apiKey || !baseUrl) {
  // Fail fast with an actionable message on stderr (stdout is the MCP channel).
  process.stderr.write(
    'POSTSIDER_API_KEY and POSTSIDER_API_URL are required. Add both to your MCP client config. ' +
