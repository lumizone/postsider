-- PostSider: Baseline migration (auto-generated from schema.prisma)
--
-- For EXISTING production databases that already have all tables:
--   pnpm dlx prisma@6.5.0 migrate resolve --applied 0_init \
--     --schema ./libraries/nestjs-libraries/src/database/prisma/schema.prisma
--
-- For FRESH installations this runs normally via: pnpm prisma-migrate-deploy
...
-- CreateEnum
CREATE TYPE "State" AS ENUM ('QUEUE', 'PUBLISHED', 'ERROR', 'DRAFT', 'APPROVAL');

-- CreateEnum
CREATE TYPE "SubscriptionTier" AS ENUM ('STANDARD', 'PRO', 'TEAM', 'ULTIMATE', 'SAMURAI');
...
-- CreateEnum
CREATE TYPE "Capability" AS ENUM ('PUBLISH', 'SOURCE', 'ANALYTICS', 'SCHEDULE');
...
-- CreateTable
CREATE TABLE "InboundEventSubscription" (
    "id" TEXT NOT NULL,
    "organizationId" TEXT NOT NULL,
    "sources" TEXT[],
    ...
    CONSTRAINT "InboundEventSubscription_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE INDEX "TrialUsage_email_idx" ON "TrialUsage"("email");
...
-- CreateIndex
CREATE INDEX "ProviderCredentials_organizationId_idx" ON "ProviderCredentials"("organizationId");

-- CreateIndex
CREATE UNIQUE INDEX "ProviderCredentials_organizationId_provider_key" ON "ProviderCredentials"("organizationId", "provider");
...
-- CreateIndex
CREATE INDEX "AuditLog_agentTokenId_idx" ON "AuditLog"("agentTokenId");

-- CreateIndex
CREATE INDEX "AuditLog_connectorId_idx" ON "AuditLog"("connectorId");
...
-- CreateIndex
CREATE INDEX "InboundEventSubscription_organizationId_idx" ON "InboundEventSubscription"("organizationId");
...
-- AddForeignKey
ALTER TABLE "ProviderCredentials" ADD CONSTRAINT "ProviderCredentials_organizationId_fkey" FOREIGN KEY ("organizationId") REFERENCES "Organization"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "AgentToken" ADD CONSTRAINT "AgentToken_organizationId_fkey" FOREIGN KEY ("organizationId") REFERENCES "Organization"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "AuditLog" ADD CONSTRAINT "AuditLog_organizationId_fkey" FOREIGN KEY ("organizationId") REFERENCES "Organization"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "AuditLog" ADD CONSTRAINT "AuditLog_agentTokenId_fkey" FOREIGN KEY ("agentTokenId") REFERENCES "AgentToken"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "InboundEventSubscription" ADD CONSTRAINT "InboundEventSubscription_organizationId_fkey" FOREIGN KEY ("organizationId") REFERENCES "Organization"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
